...
def test_capture(order_manager: OrderManager):
    ...
    This test checks if the order is captured successfully and if the response is of the correct type.
    ...
    capture_request = (
        ...
        .add_new_order_id("capture_" + order_id)
    ...
    assert order_capture.order_id == order_id
