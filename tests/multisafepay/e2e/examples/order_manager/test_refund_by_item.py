...
def test_refund_by_item(order_manager: OrderManager):
    """
    Test the refund_by_item method of the OrderManager.
    ...
    refund_response = order_manager.refund_by_item(order, "1111", 1)
