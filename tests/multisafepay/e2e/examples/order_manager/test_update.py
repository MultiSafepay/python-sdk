...
def test_update(order_manager: OrderManager):
    """
    Test the update method of the OrderManager.

    This test checks if the order is updated successfully and if the response is of the correct type.
    ...
    assert isinstance(update_response, CustomApiResponse)
    success = update_response.get_body_success()
