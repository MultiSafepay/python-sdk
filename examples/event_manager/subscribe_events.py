...
"""Subscribe to an events stream using existing event credentials."""
...
EVENTS_TOKEN = _require_env("EVENTS_TOKEN")
EVENTS_STREAM_URL = _require_env("EVENTS_STREAM_URL")
...
if __name__ == "__main__":
    ...
    try:
        with event_manager.subscribe_events(
        ...
        print("Stream interrupted by user.")# Copyright (c) MultiSafepay, Inc. All rights reserved.
